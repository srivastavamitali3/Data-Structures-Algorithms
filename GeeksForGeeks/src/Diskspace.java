 ...
 *
 * Analyze the available hard disk space on each of the computers. Determine the minimum
 * available disk space within this segment. After performing these steps for the first segment,
 * it is then repeated for the next segment, continuing this procedure until the end of the row
 ...
 *
 * Solution:
 * Based on sliding window maximum
 *
 * Time Complexity : O(n) & space complexity : O(segmentLength) as we will be remove if its is greater than segment Length
 */
